...
function dijkstra(matrix, start)
    ...
    while !isempty(pq)
        point = dequeue!(pq)
        for next_point in next_moves(matrix, point)
            cost = distances[point] + 1
            if cost < distances[next_point]
                distances[next_point] = cost
                pq[next_point] = cost
            end
        end
    end
...
heatmap([
0  0  0  7  2  6  0  0  0
0  0  7  10 14 12 6  0  0
0  7  10 14 15 14 12 6  0
7  10 14 15 14 15 14 12 6
3  14 15 14 1  14 15 14 5
8  10 14 15 14 15 14 12 9
0  8  10 14 15 14 12 9  0
0  0  8  10 14 12 9  0  0
0  0  0  8  4  9  0  0  0
])
...
# ╔═╡ a90070fd-2939-483d-a425-04d85d3cb14d
26501366^2
...
# ╔═╡ 4e97e211-7dda-410e-8e37-f22d16f424fa
26501365^2
...
#=╠═╡
begin
	distances = dijkstra(test_input_1 |> parse_input, findfirst(test_input_1 |> parse_input .== 'S'))
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "99a9f4e152465099ab4e1bd0a4f6c8666d6640f7"
